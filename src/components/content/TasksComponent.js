...
class TasksComponent extends React.Component {
    ...
    state = { items: [
        {title: 'Finish report update', checked: false, tag: TAGS.URGENT },
        {title: 'Create new report', checked: false, tag: TAGS.NEW },
        {title: 'Update report', checked: true, tag: TAGS.DEFAULT }
    ]};
